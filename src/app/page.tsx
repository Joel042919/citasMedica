        ...
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center">
              ...
              <span className="ml-2 text-xl font-bold text-gray-900">Aquí Te Curas</span>
            </div>
          ...
          <div className="relative isolate overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-32 text-center">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-600">
                Bienvenido a "Aquí Te Curas", donde combinamos la mejor atención médica con tecnología de punta para tu bienestar.
              </p>
      ...
      <footer className="bg-white border-t border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <p className="text-center text-sm text-gray-500">
            © {new Date().getFullYear()} Aquí Te Curas. Todos los derechos reservados.
          </p>
        </div>
      </footer>
